...
Event.observe(window,'load',function(){ Lightbox.initialize({autoPlay: false, strings: {
	closeLink : 'Zavrieť',
		loadingMsg : 'Načítavam',
		nextLink : 'ďalší &raquo;',
		prevLink : '&laquo; pred.',
		startSlideshow : 'Začni prezentáciu',
		stopSlideshow : 'Zastav prezentáciu',
		numDisplayPrefix : 'Obrázok',
		numDisplaySeparator : 'z' }}); });

a = document.querySelector("#search")

Event.observe(a,'change',function(){ Lightbox.initialize({autoPlay: false, strings: {
		closeLink : 'Zavrieť',
		loadingMsg : 'Načítavam',
		nextLink : 'ďalší &raquo;',
		prevLink : '&laquo; pred.',
...
/*a.addEventListener("mouseout",function(){ Lightbox.initialize({autoPlay: false, strings: {
		closeLink : 'Zavrieť',
		loadingMsg : 'Načítavam',
		nextLink : 'ďalší &raquo;',
		prevLink : '&laquo; pred.',
